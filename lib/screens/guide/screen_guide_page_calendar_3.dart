...
class GuidePageCalendarthree extends StatefulWidget {
  const GuidePageCalendarthree({super.key});

  @override
  State<GuidePageCalendarthree> createState() => _GuidePageCalendarthreeState();
} 

class _GuidePageCalendarthreeState extends State<GuidePageCalendarthree> {
    ...
    return GuidePage(
      ...
      content: Listener(
        ...
        child: Column(
          ...
          children: [
            //Sample Iamge
            Image.asset('assets/images/Calendar_3.jpg', width: 500, height: 500),
            Image.asset('assets/images/Calendar_3_2.jpg', width: 500, height: 500),

            //Sample Subescription
            const SizedBox(height: 16),
            Padding(
              padding: EdgeInsets.symmetric(horizontal: 32.0),
              child: Text(l10n.guidecalendarBody3, textAlign: TextAlign.left),
            ),
          ],
        ),
      ),
