...
/// 第一個日曆引導頁面
/// 展示如何使用 Calendar 功能的基本介紹
class ScreenGuideCalendar extends StatefulWidget {
  const ScreenGuideCalendar({super.key});

  @override
  State<ScreenGuideCalendar> createState() => _ScreenGuideCalendarState();
}

class _ScreenGuideCalendarState extends State<ScreenGuideCalendar> {
  // 滾動控制器，用於控制頁面的滾動
        ...
        child: SingleChildScrollView(
          ...
          child: Center(
            child: Column(
              ...
              children: [
                // 日曆功能示例圖片
                Image.asset('assets/images/calendar_light.jpg', width: 500, height: 500),

                const SizedBox(height: 16),
                // 日曆功能描述文字
                Padding(padding: const EdgeInsets.symmetric(horizontal: 32.0), child: Text(l10n.guidecalendarBody1, textAlign: TextAlign.left)),
              ],
            ),
          ),
        ),
