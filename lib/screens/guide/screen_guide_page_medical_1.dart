...
class GuidePageMedicalOne extends StatefulWidget {
  const GuidePageMedicalOne({super.key});

  @override
  State<GuidePageMedicalOne> createState() => _GuidePageMedicalOneState();
}

class _GuidePageMedicalOneState extends State<GuidePageMedicalOne> {
          ...
          children: [
            ...
            Text(
              ...
              Padding(
                ...
                child: Text(l10n.medintroBody1, textAlign: TextAlign.left),
              )
            ],
          ),
        ),
