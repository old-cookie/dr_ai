...
class ScreenGuideCalendarList extends StatefulWidget {
  const ScreenGuideCalendarList({super.key});

  @override
  State<ScreenGuideCalendarList> createState() => _ScreenGuideCalendarListState();
}

class _ScreenGuideCalendarListState extends State<ScreenGuideCalendarList> {
  // 滾動控制器，用於控制頁面的滾動
        ...
        child: SingleChildScrollView(
          ...
          child: Center(
            child: Column(
              ...
              children: [
                // 日曆功能示例圖片
                Image.asset('assets/images/calendar_list_light.jpg', width: 500, height: 500),

                const SizedBox(height: 16),
                // 日曆功能描述文字
                Padding(padding: const EdgeInsets.symmetric(horizontal: 32.0), child: Text(l10n.guidecalendarBody2, textAlign: TextAlign.left)),
              ],
            ),
          ),
        ),
