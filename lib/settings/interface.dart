                ...
                child: Column(children: [
                  Expanded(
                    child: ListView(children: [
                      ...
                      titleDivider(bottom: desktopLayoutNotRequired(context) ? 38 : 20, context: context),
                      SegmentedButton(
                          segments: [
                            ButtonSegment(
                                value: "stream",
                      ...
                      button(
                        ...
                        await showDialog(
                            ...
                            builder: (context) {
                              return Dialog(
                                  alignment: desktopLayout(context) ? null : Alignment.bottomRight,
                                  child: StatefulBuilder(builder: (context, setLocalState) {
                                    if (int.parse(prefs!.getString("keepAlive") ?? "0") <= 0 && loaded == false) {
                                      prefs!.setString("keepAlive", "0");
                                        ...
                                        data: (prefs?.getBool("useDeviceTheme") ?? false)
                                            ...
                                            : ThemeData.from(
                                                colorScheme: ColorScheme.fromSeed(
                                                    seedColor: Colors.black, brightness: Theme.of(context).colorScheme.brightness)),
                      ...
                      button(AppLocalizations.of(context)!.settingsTimeoutMultiplierExample, Icons.calculate_rounded, null,
                          ...
                          description: "\n${() {
                            var value = (prefs!.getDouble("timeoutMultiplier") ?? 1);
                            if (value == 10) {
                              return "${value.round()}.";
                            } else {
                      ...
                      AnimatedContainer(duration: const Duration(milliseconds: 200), height: desktopLayoutNotRequired(context) ? 16 : 8),
                      (colorSchemeLight != null && colorSchemeDark != null)
                          ? SegmentedButton(
                              ...
                              selected: {
                                  (prefs?.getBool("useDeviceTheme") ?? false) ? "device" : "ollama"
                                },
                              onSelectionChanged: (p0) async {
                                selectionHaptic();
