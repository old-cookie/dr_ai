  ...
  Widget build(BuildContext context) {
    return WindowBorder(
      ...
      child: Scaffold(
          appBar: AppBar(
              title: Row(
                  children: [Text(AppLocalizations.of(context)!.settingsTitleExport), Expanded(child: SizedBox(height: 200, child: MoveWindow()))]),
                    ...
                    child: ListView(children: [
                      ...
                      button(AppLocalizations.of(context)!.settingsExportChats, Icons.upload_rounded, () async {
                        ...
                        if (kIsWeb) {
                          ...
                          String? path = "";
                          try {
                            path = (await file_selector.getSaveLocation(acceptedTypeGroups: [
                                          ...
                                          TextButton(
                                              onPressed: () async {
                                                ...
                                                try {
                                                  ...
                                                  file_selector.XFile? result = await file_selector.openFile(acceptedTypeGroups: [
                                                    const file_selector.XTypeGroup(label: "Ollama App File", extensions: ["json"])
                                                  ]);
                                                  if (result == null) {
                                                    // ignore: use_build_context_synchronously
