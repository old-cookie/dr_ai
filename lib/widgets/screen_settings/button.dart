...
Widget button(String text, IconData? icon, void Function()? onPressed,
  ...
  if (description != null &&
      ((context != null && desktopLayoutNotRequired(context)) || !onlyDesktopDescription) &&
  ...
  return AnimatedContainer(
    ...
    padding: (context != null && desktopLayoutNotRequired(context)) ? const EdgeInsets.only(top: 8, bottom: 8) : EdgeInsets.zero,
    child: InkWell(
        ...
        onLongPress: (description != null && context != null)
            ? (desktopLayoutNotRequired(context) && !alwaysMobileDescription) || !onlyDesktopDescription
                ? null
                : () {
                    selectionHaptic();
          ...
          child: Builder(builder: (context) {
            ...
            return Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
              !(iconAfterwards ?? false)
                  ? (iconBadge == null)
                      ? iconContent
                      : Badge(label: (iconBadge != "") ? Text(iconBadge) : null, child: iconContent)
                  : const SizedBox.shrink(),
              (icon != null || replaceIconIfNull) ? SizedBox(width: !(iconAfterwards ?? false) ? 16 : null, height: 42) : const SizedBox.shrink(),
              Expanded(child: Builder(builder: (context) {
                Widget textWidget = Text(text, style: TextStyle(color: disabled ? Colors.grey : color));
                if (badge != null) {
                  textWidget = Badge(
                      label: Text(badge),
                ...
                if (iconAfterwards ?? false) {
                  return Row(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.center, children: [
                    ...
                    Transform.translate(
                        ...
                        child: (iconBadge == null) ? iconContent : Badge(label: (iconBadge != "") ? Text(iconBadge) : null, child: iconContent)),
                  ]);
                } else {
                  if (description == null || description!.startsWith("\n")) {
                    ...
                    return Column(
                        ...
                        children: [
                          textWidget,
                          (description != null && !alwaysMobileDescription && (desktopLayoutNotRequired(context) || !onlyDesktopDescription))
                              ? Text(description!, style: const TextStyle(color: Colors.grey, overflow: TextOverflow.ellipsis))
                              : const SizedBox.shrink()
                        ]);
                  } else {
                    return Row(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.center, children: [
                      ...
                      (description != null && !alwaysMobileDescription && (desktopLayoutNotRequired(context) || !onlyDesktopDescription))
                          ? Expanded(
                              child: Text(description!, style: const TextStyle(color: Colors.grey, overflow: TextOverflow.ellipsis)),
                            )
                          : const SizedBox.shrink()
                    ]);
                  }
