          ...
          child: LayoutBuilder(builder: (context, constraints) {
            return Row(mainAxisSize: MainAxisSize.max, children: [
              ...
              ConstrainedBox(
                ...
                child: Text(text, overflow: TextOverflow.ellipsis, maxLines: 1, style: TextStyle(color: disabled ? Colors.grey : null)),
              ),
              // 如果有圖標且圖標在後面，顯示圖標
              (icon != null && (iconAfterwards ?? false))
                  ? Transform.translate(
              ...
              // 分隔線
              Expanded(
                child: Padding(padding: const EdgeInsets.only(left: 16), child: Divider(color: Theme.of(context).dividerColor)),
              ),
            ]);
          }),
        ),
