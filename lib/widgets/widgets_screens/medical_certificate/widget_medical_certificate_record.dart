...
class _WidgetMedicalCertificateRecordState extends State<WidgetMedicalCertificateRecord> {
  ...
  void _editCertificate(String recordKey, Map<String, dynamic> certificate) {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => ScreenAddMedicalCertificate(recordToEdit: certificate, recordKey: recordKey)),
    ).then((_) {
      setState(() {});
      _loadCertificates();
    });
      ...
      child: Column(
        ...
        children: [
          Padding(
            ...
            child: Text(localizations.medicalCertificates, style: const TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
          ),
          _certificates.isEmpty
              ? Expanded(child: Center(child: Text(localizations.noCertificatesFound, style: TextStyle(fontSize: 16, color: Colors.grey))))
              : Expanded(
                          ...
                          builder:
                              (context) => AlertDialog(
                                ...
                                actions: [
                                  ...
                                  TextButton(onPressed: () => Navigator.of(context).pop(true), child: Text(localizations.delete)),
                                ],
                              ),
                        );
                      },
                                  ...
                                  children: [
                                    Expanded(
                                      child: Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          Text(certificate['hospital'] ?? '', style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                                    ...
                                    if (certificate['image'] != null) ...[
                                      ...
                                      SizedBox(
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: Image.memory(base64Decode(certificate['image']), fit: BoxFit.cover),
                                        ),
                                      ),
                                    ],
                                  ],
          ...
          Padding(
            ...
            child: widgetButton(
              ...
              Icons.add,
              () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => const ScreenAddMedicalCertificate())).then((_) {
                  setState(() {});
                  _loadCertificates();
                });
              },
