...
class _MainAppState extends State<MainApp> {
  ...
  List<Widget> sidebar(BuildContext context, Function setState) {
    var padding = EdgeInsets.only(
        left: isDesktopLayoutRequired(context) ? 17 : 12,
        right: isDesktopLayoutRequired(context) ? 17 : 12);
    return List.from([
      (isDesktopLayoutNotRequired(context) || kIsWeb)
      ...
      (isDesktopLayoutNotRequired(context) ||
          ...
          ? const SizedBox.shrink()
          : Divider(
              color: shouldUseDesktopLayout(context)
        ...
        var child = Padding(
            ...
            child: InkWell(
                ...
                onLongPress: (isDesktopPlatform() ||
                        (kIsWeb && isDesktopLayoutNotRequired(context)))
                    ? null
                    : () async {
                        selectionHaptic();
                        if (!chatAllowed &&
                        ...
                        child: Container(
                          ...
                          child: Chat(
                              ...
                              imageMessageBuilder: (p0,
                                ...
                                return SizedBox(
                                    width: shouldUseDesktopLayout(context)
                                        ? 360.0
                                        : 160.0,
                                    child: MarkdownBody(
                                        data: "![${p0.name}](${p0.uri})"));
                              ...
                              theme: (Theme.of(context).brightness ==
                                  ...
                                  ? DefaultChatTheme(
                                      ...
                                      inputMargin: EdgeInsets.only(left: !isDesktopPlatform(includeWeb: true) ? 8 : 6, right: !isDesktopPlatform(includeWeb: true) ? 8 : 6, bottom: (MediaQuery.of(context).viewInsets.bottom == 0.0 && !isDesktopPlatform(includeWeb: true)) ? 0 : 8),
