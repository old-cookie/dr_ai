...
import '../../screens/guide/screen_guide_ai_chat.dart';
import '../../main.dart';
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        AppLocalizations.of(context)!.optionVaccine,
                        softWrap: false,
                        overflow: TextOverflow.fade,
                        style: const TextStyle(fontWeight: FontWeight.w500),
                      ),
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        AppLocalizations.of(context)!.optionBMI,
                        softWrap: false,
                        overflow: TextOverflow.fade,
                        style: const TextStyle(fontWeight: FontWeight.w500),
                      ),
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        AppLocalizations.of(context)!.optionMedicalCertificate,
                        softWrap: false,
                        overflow: TextOverflow.fade,
                        style: const TextStyle(fontWeight: FontWeight.w500),
                      ),
          ...
          ? (Padding(
            ...
            child: InkWell(
              ...
              onTap: () {
                ...
                Navigator.push(context, MaterialPageRoute(builder: (context) => const ScreenCalendar()));
              },
              child: Padding(
                padding: const EdgeInsets.only(top: 16, bottom: 16),
                child: Row(
                  children: [
                    Padding(padding: const EdgeInsets.only(left: 16, right: 12), child: const Icon(Icons.calendar_month)),
                    Expanded(
                      child: Text(
                        AppLocalizations.of(context)!.optionCalendar,
                        softWrap: false,
                        overflow: TextOverflow.fade,
                        style: const TextStyle(fontWeight: FontWeight.w500),
                      ),
                ...
                child: Row(
                  children: [
                    Padding(
                      padding: const EdgeInsets.only(left: 16, right: 12),
                      child:
                          isDesktopLayoutNotRequired(context) ? const Icon(Icons.install_desktop_rounded) : const Icon(Icons.install_mobile_rounded),
                    ),
                    Expanded(
                      child: Text(
      ...
      (prefs.getStringList("chats") ?? []).map((item) {
        var child = Padding(
          ...
          child: InkWell(
            ...
            onLongPress:
                (isDesktopPlatform() || (kIsWeb && isDesktopLayoutNotRequired(context)))
                    ? null
                    : () async {
                      selectionHaptic();
              ...
              child: Row(
                children: [
                  ...
                  AnimatedSwitcher(
                    ...
                    child:
                        (((isDesktopPlatform() || (kIsWeb && isDesktopLayoutNotRequired(context))) && (hoveredChat == jsonDecode(item)["uuid"])) ||
                                !allowMultipleChats)
                            ? Padding(
                              padding: const EdgeInsets.only(left: 16, right: 16),
                              child: SizedBox(
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      if (GuideService.shouldShowGuide()) {
        if (mounted) {
          Navigator.of(context).push(MaterialPageRoute(builder: (context) => const GuideExample()));
        }
      }
    });
                    ...
                    ? isDesktopLayoutRequired(context)
                        ? [
                          ...
                          AnimatedOpacity(
                            ...
                            child: Padding(padding: const EdgeInsets.all(16), child: selector),
                          ),
                      ...
                      child: Container(
                        ...
                        child: Chat(
                                    ...
                                    Widget errorImage = InkWell(
                                      onTap: () {
                                        ...
                                        ScaffoldMessenger.of(
                                          context,
                                        ).showSnackBar(SnackBar(content: Text(AppLocalizations.of(context)!.notAValidImage), showCloseIcon: true));
                                      },
                                      child: Container(
                                  ...
                                  styleSheet:
                                      (p0.author == user)
                                          ? MarkdownStyleSheet(
                                            ...
                                            blockquoteDecoration: BoxDecoration(color: Colors.grey[800], borderRadius: BorderRadius.circular(8)),
                                          ...
                                          ? MarkdownStyleSheet(
                                            p: TextStyle(color: greyed ? Colors.grey : Colors.black, fontSize: 16, fontWeight: FontWeight.w500),
                                            blockquoteDecoration: BoxDecoration(color: Colors.grey[200], borderRadius: BorderRadius.circular(8)),
                          ...
                          imageMessageBuilder: (p0, {required messageWidth}) {
                            return SizedBox(
                              width: shouldUseDesktopLayout(context) ? 360.0 : 160.0,
                          ...
                          onMessageLongPress: (context, p1) async {
                            ...
                            messages[index] = types.TextMessage(author: p1.author, createdAt: p1.createdAt, id: p1.id, text: input);
                            setState(() {});
                          },
                          onAttachmentPressed:
                              (!multimodal)
